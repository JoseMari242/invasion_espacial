...
# puntaje
puntaje = 0
fuente = pygame.font.Font('Simple.otf', 32)
texto_x = 10
texto_y = 10

# texto final de juego
fuente_final = pygame.font.Font('Simple.otf', 40)
...
while se_ejecuta:
    ...
    # mantener en limites al jugador
    if jugador_x <= 0:
        jugador_x = 0
    elif jugador_x >= 738:
        jugador_x = 738
    ...
    # mantener en limites al enemigo
        if enemigo_x[e] <= 0:
